process.env['TELEGRAM_ALLOWED_USERNAMES'] = 'pedro_mol;flaviaveloso';
process.env['TELEGRAM_TOKEN'] = '5501741231:AAFykY95j4bQvMMM-0T1oIKvqmmiPjMVKUE';
process.env['SSH_HOST'] = '192.168.1.10';
process.env['SSH_USERNAME'] = 'mol';
process.env['SSH_PASSWORD'] = 'Kiba1Maroto2';
